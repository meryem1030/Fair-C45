...
def drop_dominateds(np_table):
    ...
    for index in dominated_attributes:
        ...
        np_table = np.delete(np_table, i, 0) 
    return np_table
...
def run(metadata, data, df, data_test, pro_index, categorical_features, pri_val, unpri_val, pri_class, non_pri_class,user_defined_threshold):
    test = data_test
    train = data
    ...
    print('\n\n===>Disparate Treatment Result: ', DT)

    return ('ACCURACY:',acc), ('ROC_AUC:', roc_auc), ('FPR RESULT:', FPR_Diff), ('FNR RESULT:', FNR_Diff), ('DISPARATE IMPACT:', DI), ('CV SCORE:', CV), ('CONSISTENCY:', cons), ('Disparate Treatment:', DT)

run(metadata, data, df, data_test, 0,categorical_features,1, 0, 1, 0, user_defined_threshold=24)
