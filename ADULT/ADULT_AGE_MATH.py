...
def run(metadata, data, df, data_test, pro_index, categorical_features, pri_val, unpri_val, pri_class, non_pri_class,user_defined_threshold):
    ...
    return ('ACCURACY:',acc), ('ROC_AUC:', roc_auc), ('FPR RESULT:', FPR_Diff), ('FNR RESULT:', FNR_Diff), ('DISPARATE IMPACT:', DI), ('CV SCORE:', CV), ('CONSISTENCY:', cons), ('Disparate Treatment:', np.mean(DT))
