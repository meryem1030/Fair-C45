...
def load_csv(path): 
    ...
    columns_to_drop = ['id','name','first','last','compas_screening_date','dob','is_recid','decile_score',
                       'days_b_screening_arrest','c_jail_in','c_jail_out','c_case_number','c_offense_date',
                       'c_arrest_date','c_days_from_compas','c_charge_desc','r_case_number','r_charge_degree',
                       'r_days_from_arrest','r_offense_date','r_charge_desc','r_jail_in','r_jail_out','violent_recid',
                       'is_violent_recid','vr_case_number','vr_charge_degree','vr_offense_date','vr_charge_desc','type_of_assessment',
                       'screening_date', 'v_type_of_assessment', 'v_decile_score', 'v_screening_date', 'in_custody', 'out_custody', 
                       'start', 'end','event']
...
df,categorical_features, metadata_original, data = load_csv(r'propublica_recidivism.csv')
...
run(metadata, data, df, part, 3,categorical_features, 1, 2, 0, 1)
